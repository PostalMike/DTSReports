namespace Components
{
    public class ReportsConstants
    {
        ...
        public const string RESX_ModuleCommon = "~/DesktopModules/DTSReports/App_LocalResources/SharedResources.resx";
        ...
        // Reports Client API
        public const string ReportsScript = "~/DesktopModules/DTSReports/js/dnn.reports.js";

<%@ Control Language="C#" AutoEventWireup="true" Codebehind="Settings.ascx.cs" Inherits="DotNetNuke.Modules.DTSReports.DataSources.SqlServer.Settings" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<%@ Register Src="~/DesktopModules/DTSReports/Controls/SqlDataSourceCommonSettingsControl.ascx" TagName="SqlDataSourceCommonSettingsControl"

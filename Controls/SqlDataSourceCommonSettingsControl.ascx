<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SqlDataSourceCommonSettingsControl.ascx.cs" Inherits="DotNetNuke.Modules.DTSReports.Controls.SqlDataSourceCommonSettingsControl" %>
